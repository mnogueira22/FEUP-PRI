...
app.post('/solr-query', async (req, res) => {
    ...
    let solrUrl = `http://localhost:8983/solr/formula1/select?defType=edismax&df=*&indent=true&pf=summary^5&ps=3&q.op=AND&q=${encodeURIComponent(query)}&rows=1125&qf=name^5%20circuit^4%20country^3%20location^2%20weather_condition^2%20summary^2%20drivers^10&useParams=`;
